...
namespace CapaAccesoDatos
{
    public class DACurso
    {
        ...
        public int InsertarCursos(EntidadCurso curso)
        {
            ...
            string sentencia = "INSERT INTO Cursos(Nombre_Curso, Cantidad_Horas,Precio_Hora, Estado_Curso ) VALUES(@NOMBRE_CURSO, @CANTIDAD_HORAS," +
        ...
        public int ActualizarCurso(EntidadCurso curso)
        {
            ...
            String sentencia = "UPDATE Cursos SET Nombre_Curso = @NOMBRE_CURSO, " +
                "Cantidad_Horas = @CANTIDAD_HORAS,Precio_Hora = @PRECIO_HORAS, Estado_Curso = @ESTADO_CURSO WHERE ID_Curso = @ID_CURSO";
            cmd.CommandText = sentencia;
            cmd.Connection = conexion;
            ...
            cmd.Parameters.AddWithValue("@ESTADO_CURSO", curso.Estado);
